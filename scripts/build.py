...
body = '<section class="product-hero"><div>'+heading('SMALL GAMES / BOARD', 'Backgammon', 'Dice you can check, keepers you can measure, bear-offs worked out exactly.')+button('Play now', 'https://morassgames.com/games/backgammon/')+'<p class="small-note">Free \u00b7 No account \u00b7 Plays on morassgames.com</p></div><img src="/assets/projects/backgammon.webp" width="1200" height="675" alt="A backgammon board of sea-oak with salt-white and iron-stone checkers, a pale checker lifted from the bar with its two landings marked by the dice they use, and the doubling cube in the middle"></section>'
body += '<section class="prose"><h2>The dice you can check</h2><p>Full backgammon: hitting, the bar, bearing off, gammons and backgammons, and matches of 1, 3, 5 or 7 points with the doubling cube and the Crawford rule. Before the first roll the table shows a seal that fixes every die of the match; you may cut it with words of your own, and when the match ends the secret is revealed so anyone can recompute every roll. The ledger counts both sides\' luck too.</p><p>Seven computer keepers, from Deckhand to Pilot, share one judgement trained by self-play; each step up the ladder was measured over a thousand games on shared dice. After each keeper play, Why? shows the plays it liked and its own estimates. The 120 Trials are bear-offs where one play wins most often, worked out exactly; the fastest first solve of each goes on the board.</p></section>'
page('/small-games/backgammon/', 'Backgammon', 'Free fantasy Backgammon: seven measured computer opponents, provably fair sealed dice, the doubling cube, and 120 exact bear-off Trials with public time records.', body, 'small-games', [('Small Games','/small-games/'),('Backgammon','/small-games/backgammon/')], '/assets/projects/backgammon.webp')

body = '<section class="product-hero"><div>'+heading('SMALL GAMES / BOARD', 'Battleships', 'Hide your brood in the fog. Cast storm-runes into theirs.')+button('Play now', 'https://morassgames.com/games/battleships/')+'<p class="small-note">Free \u00b7 No account \u00b7 Plays on morassgames.com</p></div><img src="/assets/projects/battleships.webp" width="1200" height="675" alt="A ten by ten fogbank of pale squares off a dark sea: two surfaced red Salt-Wyrms lie in cleared water among ring-marked splashes, and a small chart of your own green wyrms sits beside it"></section>'
body += '<section class="prose"><h2>Six sea-witches and 120 Hunts</h2><p>Battleships with Salt-Wyrms instead of ships. Hide your five wyrms in your fogbank, then take turns casting into your rival\'s: a splash is water, a strike lights a coil, and the last strike on a wyrm makes it surface. Wyrms never touch, not even at a corner, so the water around a surfaced wyrm clears. The rival\'s brood is sealed before your first cast, and the seal opens at the end so you can check it never moved.</p><p>Six sea-witches, from the forgetful Gull-Witch to the Storm-Caller, were each measured a step stronger than the last; after any of their casts, Why? shows how they chose. The 120 Hunts give you the fishers\' soundings, the wyrm squares under every row and column, and each has exactly one answer found without a guess. Each Hunt keeps the fastest first solve and the fewest casts.</p></section>'
page('/small-games/battleships/', 'Battleships', 'Free fantasy Battleships: six measured computer opponents with a sealed, checkable fleet, and 120 one-answer Hunts with public records for time and fewest casts.', body, 'small-games', [('Small Games','/small-games/'),('Battleships','/small-games/battleships/')], '/assets/projects/battleships.webp')
body = '<section class="product-hero"><div>'+heading('SMALL GAMES / BOARD', 'Mancala', 'Every rule shown on the board before you need it.')+button('Play now', 'https://morassgames.com/games/mancala/')+'<p class="small-note">Free \u00b7 No account \u00b7 Plays on morassgames.com</p></div><img src="/assets/projects/mancala.webp" width="1200" height="675" alt="A carved stone Mancala board in a granary loft at dusk: two rows of six pits holding grain, a granary at each end, and the path of the next sowing numbered one to six, ending in the player\'s granary"></section>'
body += '<section class="prose"><h2>Learn it by sowing</h2><p>Kalah, the Mancala most people know: six pits a side, four seeds in each. Sow from your row counter-clockwise, into your own granary and past your opponent\'s. A last seed in your granary sows again; a last seed in an empty pit of yours captures the seeds facing it; when a row runs dry the fuller granary wins. Tap a pit and every pit its seeds will reach is numbered, with what the last seed will do, before you commit.</p><p>Five short lessons teach each rule on the real board. Six tithe-factors, from a careless gleaner-boy to the Tithe-Master, were each measured stronger than the last over three hundred games, and Why? shows how they scored every pit. The 120 Trials are endgames where exactly one first sowing keeps a win against a defender that never errs; each keeps the fastest first win and the fewest sowings.</p></section>'
page('/small-games/mancala/', 'Mancala', 'Free fantasy Mancala (Kalah): hands-on lessons for every rule, six measured computer opponents, and 120 exact endgame Trials with public records for time and fewest sowings.', body, 'small-games', [('Small Games','/small-games/'),('Mancala','/small-games/mancala/')], '/assets/projects/mancala.webp')
