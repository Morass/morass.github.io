...
body += '<section class="rules"><p class="eyebrow">HOW TO PLAY</p><h2>Make the pane whole again.</h2><ol><li>Pick a picture and a cut, and drag a shard towards where it belongs.</li><li>Near is near enough: let it go anywhere close and it takes, with a click, and nothing you do afterwards can knock it out.</li><li>A shard dropped anywhere else stays exactly where you put it, so you can sort the bench into colours and it will keep.</li></ol><p>Twelve painted places at four leaded cuts \u2014 six shards to ninety-six \u2014 and a fresh scramble and a fresh cut every time. No rotation, no zoom and nothing too small to grab; no advertisement between you and the piece you were placing. Leave, reload, or lose the tab and the pane is waiting with every shard where you left it. Forty-eight public boards of ten, and nothing sends a number: a finished pane is sent as its replay and set again on the server.</p></section>'
page('/small-games/jigsaw/', 'Jigsaw', 'Free fantasy jigsaw puzzle: twelve painted panes, four cuts to ninety-six shards, pieces that stick, and a board that survives a closed tab.', body, 'small-games', [('Small Games','/small-games/'),('Jigsaw','/small-games/jigsaw/')], '/assets/projects/jigsaw.webp')
